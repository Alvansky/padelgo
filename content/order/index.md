...
<button type="button" data-court="A1" class="court-btn rounded-xl border border-slate-200 p-4 text-left transition hover:border-blue-500 hover:bg-blue-50 dark:border-slate-700 dark:hover:bg-blue-500/10"><span class="block text-lg font-extrabold text-slate-950 dark:text-white">A1</span><span class="text-sm text-slate-500 dark:text-slate-400">Premium</span></button>
<button type="button" data-court="A2" class="court-btn rounded-xl border border-slate-200 p-4 text-left transition hover:border-orange-500 hover:bg-orange-50 dark:border-slate-700 dark:hover:bg-orange-500/10"><span class="block text-lg font-extrabold text-slate-950 dark:text-white">A2</span><span class="text-sm text-slate-500 dark:text-slate-400">Standard</span></button>
<button type="button" data-court="B1" class="court-btn rounded-xl border border-slate-200 p-4 text-left transition hover:border-violet-500 hover:bg-violet-50 dark:border-slate-700 dark:hover:bg-violet-500/10"><span class="block text-lg font-extrabold text-slate-950 dark:text-white">B1</span><span class="text-sm text-slate-500 dark:text-slate-400">Premium</span></button>
<button type="button" data-court="B2" class="court-btn rounded-xl border border-slate-200 p-4 text-left transition hover:border-pink-500 hover:bg-pink-50 dark:border-slate-700 dark:hover:bg-pink-500/10"><span class="block text-lg font-extrabold text-slate-950 dark:text-white">B2</span><span class="text-sm text-slate-500 dark:text-slate-400">Standard</span></button>
</div>
...
<button type="button" data-court="A1" class="court-map-card relative h-36 overflow-hidden rounded-2xl text-white shadow-sm transition hover:-translate-y-1"><span class="absolute inset-0 bg-gradient-to-br from-blue-500 to-blue-800"></span><span class="relative flex h-full flex-col items-center justify-center"><span class="text-2xl font-extrabold">A1</span><span class="text-sm opacity-85">Premium</span></span></button>
<button type="button" data-court="B1" class="court-map-card relative h-36 overflow-hidden rounded-2xl text-white shadow-sm transition hover:-translate-y-1"><span class="absolute inset-0 bg-gradient-to-br from-violet-500 to-violet-800"></span><span class="relative flex h-full flex-col items-center justify-center"><span class="text-2xl font-extrabold">B1</span><span class="text-sm opacity-85">Premium</span></span></button>
<button type="button" data-court="A2" class="court-map-card relative h-36 overflow-hidden rounded-2xl text-white shadow-sm transition hover:-translate-y-1"><span class="absolute inset-0 bg-gradient-to-br from-orange-400 to-orange-700"></span><span class="relative flex h-full flex-col items-center justify-center"><span class="text-2xl font-extrabold">A2</span><span class="text-sm opacity-85">Standard</span></span></button>
<button type="button" data-court="B2" class="court-map-card relative h-36 overflow-hidden rounded-2xl text-white shadow-sm transition hover:-translate-y-1"><span class="absolute inset-0 bg-gradient-to-br from-pink-500 to-pink-800"></span><span class="relative flex h-full flex-col items-center justify-center"><span class="text-2xl font-extrabold">B2</span><span class="text-sm opacity-85">Standard</span></span></button>
</div>
</div>
